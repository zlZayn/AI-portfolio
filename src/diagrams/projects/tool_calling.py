...
def render() -> str:
    ...
    canvas.zone(640, 264, 256, 152, "Guarded execution")
    ...
    canvas.connector(((736, 184), (736, 280)), "CODE TOOLS", "default", (788, 252))
    canvas.connector(((824, 316), (864, 316), (864, 236)), style="default")
    canvas.connector(((808, 148), (864, 148), (864, 196)), "READ ONLY", "dashed", (848, 132))
    ...
    canvas.node(672, 280, 152, 72, "Policy + timeout", "blocklist / 30s", "GUARD")
    canvas.node(824, 196, 104, 72, "Result", "string", "OUTPUT", "success")
