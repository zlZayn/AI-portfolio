...
def render() -> str:
    ...
    canvas.connector(((528, 296), (600, 296), (600, 344)), style="accent")
    canvas.connector(((656, 376), (728, 376), (728, 320)), style="accent")
    canvas.connector(((784, 296), (856, 296), (856, 424)))

    canvas.node(160, 104, 112, 64, "Goal", "human intent", "INPUT", "muted")
    canvas.node(288, 184, 112, 64, "Plan JSON", "N stages", "PLANNER")
    canvas.node(416, 264, 112, 64, ("Agent xK", "PARALLEL WITHIN"), "stage outputs", "POOL")
    canvas.node(544, 344, 112, 64, "BRIDGE CONTEXT", "focused handoff", "AI", "focal")
    canvas.node(672, 264, 112, 64, ("Agent xM", "PARALLEL WITHIN"), "next outputs", "POOL")
