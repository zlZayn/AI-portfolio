...
def render() -> str:
    ...
    canvas.connector(((112, 236), (144, 236), (144, 340), (176, 340)))
    canvas.connector(((264, 96), (264, 64), (480, 64), (480, 196)))
    canvas.connector(((264, 380), (264, 420), (480, 420), (480, 308)))
    canvas.connector(((480, 196), (480, 108), (736, 108)), "PASS", "success", (624, 92))
    canvas.connector(((560, 252), (664, 252)), "ESCALATE", "accent", (612, 236))
    canvas.connector(((752, 292), (752, 332), (640, 332), (640, 364)))
